...
const LinkedInPostCreator = () => {
  ...
  const API_KEY = "87054B13-4D6F4852-ADAF65BC-99B8B62C";
  const userProfilePicture = "https://via.placeholder.com/40"; // Default placeholder for LinkedIn profile
  ...
  const handlePostSubmit = async (e) => {
    ...
    try {
      // Prepare request body for Ayrshare API
      const postData = {
        post: postMessage,
        platforms: ["linkedin"]
      };
      ...
      // Call Ayrshare API to post to LinkedIn
      ...
      if (response.ok) {
        setSuccess('Post published to LinkedIn successfully!');
        setPostMessage('');
        setImageUrl('');
        setCharCount(0);
        setPreviewUrl('');
  ...
  return (
    <div style={styles.container}>
      <h1 style={styles.title}>Create LinkedIn Post</h1>
      ...
      <div style={styles.formContainer}>
        <div style={styles.userInfo}>
          ...
          />
          <span style={styles.userName}>Your LinkedIn Profile</span>
        </div>
        ...
        <div style={styles.inputGroup}>
          ...
          />
          <span style={styles.charCount}>{charCount}/3000</span>
        </div>
